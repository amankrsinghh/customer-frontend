      ...
      <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          <input
            ...
            placeholder="Search…"
            className="w-full sm:w-44 rounded-full border border-ink/15 bg-white px-4 py-2 text-sm outline-none focus:border-rose-gold"
          />
          <select
            value={sort}
            onChange={(e) => setSort(e.target.value as "new" | "lo" | "hi")}
            className="w-full sm:w-auto rounded-full border border-ink/15 bg-white px-4 py-2 text-sm outline-none focus:border-rose-gold"
          >
